...
CREATE TABLE FINANCIAL(
    ...
    Total_Wales_per_Crime   NUMBER(8) DEFAULT(0),
...
INSERT INTO REGION(REGION_ID,REGION_NAME) VALUES (REGION_SEQ.nextval,'South West, Wales');
INSERT INTO REGION(REGION_ID,REGION_NAME) VALUES (REGION_SEQ.nextval,'East Wales');
INSERT INTO REGION(REGION_ID,REGION_NAME) VALUES (REGION_SEQ.nextval,'North West, Wales');
INSERT INTO REGION(REGION_ID,REGION_NAME) VALUES (REGION_SEQ.nextval,'Cardiff');

------------------------------------------------------------------------LOCATION-----------------------------------------------------------------------------------

INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,1,'ASHROAD','CF10','CARDIFF',5);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,2,'STREET1','NP2','NEWPORT',2);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,12,'STREET5','SW46','Swansea',3);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET3','LL8','Conwy',4);

INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET5','SA10','Port talbot',2);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET3','LL58','Anglsey',4);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET2','CA5','Cardiff',5);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET3','CH1','Flintshire',3);
INSERT INTO LOCATION (location_id,House_no,street_name,post_code,city_name,region_id) VALUES (LOCATION_SEQ.nextval,5,'STREET8','CF46','Merthyr Tydfil',2);
...
INSERT INTO FINANCIAL (financial_id,financial_year,Total_Wales_per_Crime) VALUES (FINANCIAL_SEQ.nextval,2015,0);
INSERT INTO FINANCIAL (financial_id,financial_year,Total_Wales_per_Crime) VALUES (FINANCIAL_SEQ.nextval,2016,0);
INSERT INTO FINANCIAL (financial_id,financial_year,Total_Wales_per_Crime) VALUES (FINANCIAL_SEQ.nextval,2017,0);
INSERT INTO FINANCIAL (financial_id,financial_year,Total_Wales_per_Crime) VALUES (FINANCIAL_SEQ.nextval,2018,0);
INSERT INTO FINANCIAL (financial_id,financial_year,Total_Wales_per_Crime) VALUES (FINANCIAL_SEQ.nextval,2019,0);
...
--------------------------------------------------reporter--------------------------------------------------
INSERT INTO crime_reporter(reporter_id,reporter_name,address) VALUES (1,'RAVINDER','CF1 HYDE PARK');
INSERT INTO crime_reporter(reporter_id,reporter_name,address) VALUES (2,'SANAL','CF6 GROVE AVE');
INSERT INTO crime_reporter(reporter_id,reporter_name,address) VALUES (3,'VISHWANATH','ASHVILL TERRACE, CF6');
INSERT INTO crime_reporter(reporter_id,reporter_name,address) VALUES (4,'SANAL','CF6 THE GROVE ');
INSERT INTO crime_reporter(reporter_id,reporter_name,address) VALUES (5,'ALEX','CF11 CARDIFF');
--------------------------------------------------------------------------CRIME_V----------------------------------------------
